...
export const KeyValue: React.FC<{k: IconType, v: string, link?: string}> = props => <div style={{fontSize:MIN_FONT_SIZE,margin:'0 0 10px 0'}}>
    <p>
        ...
        <span style={{marginLeft: 8, verticalAlign: 'middle', paddingBottom: 1, color: MAIN_THEME_LESS_EMPHASIS_COLOR}}>{
