...
const additionalAllowedWords: string[] = [
    "—", '+', "—",
    'contractor', 'report', 'microservice', 'workspace', 'runtime', 'workflow', 'OAuth', 'RBAC', "AuthN", "AuthZ",
    'record', 'monorepo', 'dev', 'etc.', "into", "config", "CTO", 'per', 'discount', 'recognition', 'rearchitecture',
    'resolution', 'IDE', 'redesign',
    // Proper nouns
    ...
    "Lerna", "AsyncIterator", "v2", "ReactXP", "ORM", "ERB", "EC2", "CI/CD", "Elasticsearch", "Terraform", "IaC", "CDK",
    "DynamoDB", "Serverless", 'Kotlin', 'Cognito'
];
