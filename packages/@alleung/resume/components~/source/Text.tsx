...
const additionalAllowedWords: string[] = [
    ...
    // Tech lingo
    'OAuth', 'OAuth2', 'RBAC', "AuthN", "AuthZ", "AuthZN", 'monorepo', 'dev', 'etc.', "config", "CTO", 'IDE', "SWE", 'w/', "TPM", 'microservice', "UI", "i18n",
    // Proper nouns
    ...
    "DynamoDB", "Serverless", 'Kotlin', 'Cognito', 'Crypto', 'EVM', 'Solana', "GCP", "Nx", "NFT", "K8s", "DAO",
    // Numbers
